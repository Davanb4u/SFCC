...
const TestCaseName = 'TC002_AmandaOTA_GJ_BBStartFiber_24Months_bindingperiod_with_RGW';


test('TC002_AmandaOTA_GJ_BBStartFiber_24Months_bindingperiod_with_RGW', async function ({ browser }) {
