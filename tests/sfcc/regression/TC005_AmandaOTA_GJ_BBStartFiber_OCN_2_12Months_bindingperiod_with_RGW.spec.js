...
const TestCaseName = 'TC005_AmandaOTA_GJ_BBStartFiber_OCN_2_12Months_bindingperiod_with_RGW';

test('TC005_AmandaOTA_GJ_BBStartFiber_OCN_2_12Months_bindingperiod_with_RGW', async function ({ browser }) {
  ...
  try{
    ...
    await cartPage.addProductToTheCart(utilityFunctionLocal,LocalTestData);
