...
const TestCaseName = 'TC004_Standalone_CustomerSearch_with_TSCID';

test('TC004_Standalone_CustomerSearch_with_TSCID', async function ({ page }) {
 ...
 // const context = await browser.newContext();
  ...
  try{
    ...
    await customerSearchPage.CustomerSearchPageWithTSCID(Tscid);
