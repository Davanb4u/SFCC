...
const TestCaseName = 'TC002_Standalone_AddressSearch';

test('TC002_Standalone_AddressSearch', async function ({ page }) {
  ...
  try{
    ...
    await customerSearchPage.CustomerSearchPageWithOrganisationNumber(OrgNum);
    ...
    //step 6 - check the qualified product 
    await cartPage.checkQualifiedProduct(utilityFunctionLocal,LocalTestData);
