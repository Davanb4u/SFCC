...
const TestCaseName = 'TC003_Standalone_CustomerSearch_with_OrganisationNumber';

test('TC003_Standalone_CustomerSearch_with_OrganisationNumber', async function ({ page }) {
  ...
  try{
    ...
    //step 2 - customer search page with organisation number
