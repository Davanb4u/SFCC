...
const TestCaseName = 'TC001_Standalone_PoinIDSearch';

test('TC001_Standalone_PoinIDSearch', async function ({ page }) {
  ...
  try{
    ...
    await customerSearchPage.CustomerSearchPageWithOrganisationNumber(Tscid);
