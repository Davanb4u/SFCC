...
class ContractPage {
    ...
    constructor(page) {
        ...
        this.contractSkapaAvtalsdokumentHeaderValjavtalsmallText = this.page.getByRole('heading', { name: 'Välj avtalsmall' });
        ...
        //this.manualSigningMottagetDatumCalendarIcon = this.page.locator("//span[(text()='Mottaget Datum')]//ancestor::flowruntime-base-section//input[@name='Received_Date']//parent::div//lightning-button-icon[@exportparts='button-icon']");
        //this.manualSigningKundsignaturDatumCalendarIcon = this.page.locator("//span[(text()='Kundsignaturdatum')]//ancestor::flowruntime-base-section//input[@name='CustomerSignedDate']//parent::div//lightning-button-icon[@exportparts='button-icon']");
    }
    ...
    async testDataCleanupCancelMCSalesContract(TestData, utilityFunction) {
        ...
        if (TestData.get("SalesFlowType") === "NewSales" || TestData.get("SalesFlowType") === "LegacyNegotiation" || TestData.get("SalesFlowType") === "UtilizerBreakout") {
            ...
            //console.log(" SalesFlowType -- NewSales, LegacyNegotiation , UtilizerBreakout  :: contractID =: " + contractID + " =:  Query - " +  "select Id, Status from Contract where AccountId =\'" + accountID + "\' and Status != \'Cancelled\' and Contract_Record_Type__c = \'Ramavtal\'" );        } else if (TestData.get("SalesFlowType") === "Renegotiation" || TestData.get("SalesFlowType") === "Inforhandling" || TestData.get("SalesFlowType") === "Tillaggsforhandling") {
            ...
            //console.log("SalesFlowType -- Renegotiation, Inforhandling ,Tillaggsforhandling  :: contractID =: " + contractID + " =:  Query - " + "select Id, Status from Contract where AccountId =\'" + accountID + "\' and Status != \'Cancelled\' and Status != \'Active\' and Contract_Record_Type__c = \'Ramavtal\'" );
        }
    ...
    async performMCSalesContractApproval(TestData) {
        //..**     console.log("FuncMeth  :: performMCSalesContractApproval,  TestData :: " + TestData ) 

        await this.changeTheStatusToNext.hover();
        await this.changeTheStatusToNext.click();
        await this.contractStatusAsSendForApproval.hover();
        await this.contractStatusAsSendForApproval.click();
        await this.page.reload();
        await this.changeTheStatusToNext.hover();
        await this.changeTheStatusToNext.click();
        await this.contractStatusAsApproved.hover();
    ...
    async performMCSalesSkapaAvtalsdokument(TestData) {
        //..**         console.log("FuncMeth  :: performMCSalesSkapaAvtalsdokument) 
        await this.page.reload();
        ...
        */
        ...
        await this.page.locator("//div[@id='action' and @class='vlocity-actions']//span[text()='Skapa avtalsdokument']//parent::button").click();   
        // console.log("contract page- clicked on button Skapa avtalsdokument"); 

        var Products = (TestData.get("Products")).split(";");
        var ITDaasFlag, ITSupportFlag, ConnectedOfficeFlag, TPPlusFlag, M365Flag, SmartConnectFlag;
        for (let iteration = 0; iteration < Products.length; iteration++) {
            ...
            if (Products[iteration] === "Smart Connect") {
                SmartConnectFlag = "Yes";
                console.log("SmartConnectFlag = 'Yes'")
            }
        }
        ...
        if (ConnectedOfficeFlag === "Yes" || TPPlusFlag === "Yes" || M365Flag === "Yes") {
            ...
            await this.page.getByText('Observera att IT-avdelning, Touchpoint Plus, Microsoft 365').click();
            await this.page.getByRole('button', { name: 'Nästa' }).click();
            await this.page.waitForTimeout(5000);
            //Ange kvantitet Page
            await this.page.getByRole('heading', { name: 'Ange kvantitet' }).click();            
            await this.page.getByText('Vill du ändra/uppdatera kvantitet?').click();
            //Ange kvantitet = Nej
            await this.page.locator("//label[@class='slds-radio__label']//span[ text()='Nej']").click();
            await this.page.getByRole('button', { name: 'Nästa' }).click();
        } else if ( ITDaasFlag === "Yes" || ITSupportFlag === "Yes" ) {            
            await this.page.waitForTimeout(5000);
            //Ange kvantitet Page
            await this.page.getByRole('heading', { name: 'Ange kvantitet' }).click();            
            await this.page.getByText('Vill du ändra/uppdatera kvantitet?').click();
        ...
        //TC-002Fail
            ...
            */
            ...
            /*
            await this.page.locator("//vlocity_cmt-output-field[contains(normalize-space(.),'')]//parent::div//preceding-sibling::div//vlocity_cmt-flex-icon[contains(@data-element-label,'icon_expanditem')]").first().click();
            await this.page.waitForTimeout(10000);
            const button = await this.page.locator("//vlocity_cmt-output-field[contains(normalize-space(.),'')]//ancestor::div[@class='slds-grid slds-wrap']//div[contains(@class,'slds-col condition-element slds-m-left_medium slds-size') and not(contains(@class,'hide'))]//vlocity_cmt-flex-icon[contains(@data-element-label,'icon_expanditem')]").count();
            if (button) {
                await this.page.locator("//vlocity_cmt-output-field[contains(normalize-space(.),'')]//ancestor::div[@class='slds-grid slds-wrap']//div[contains(@class,'slds-col condition-element slds-m-left_medium slds-size') and not(contains(@class,'hide'))]//vlocity_cmt-flex-icon[contains(@data-element-label,'icon_expanditem')]").first().click();
            }
            await this.page.waitForTimeout(10000);
            await this.page.locator("//c-cf-product-quantity-card_product-info[contains(normalize-space(.),'')]//vlocity_cmt-base-input-element[@data-element-label='quotequantity']//input[@class='vlocity-input slds-input' and not(@disabled)]").nth(1).clear();
            await this.page.locator("//c-cf-product-quantity-card_product-info[contains(normalize-space(.),'')]//vlocity_cmt-base-input-element[@data-element-label='quotequantity']//input[@class='vlocity-input slds-input' and not(@disabled)]").nth(1).type("5");
            await this.page.getByRole('button', { name: 'Nästa' }).click();
            */        


        await this.contractSkapaAvtalsdokumentHeaderValjavtalsmallText.click();
        ...
        if (TestData.get("SalesFlowType") === "NewSales" || TestData.get("SalesFlowType") === "LegacyNegotiation" || TestData.get("SalesFlowType") === "UtilizerBreakout") {
            ...
            //'Vill du lägga till fler erbjudanden i bilaga 1 (Tjänstekatalog)?']            
            await this.page.locator("// vlocity_cmt-omniscript-step[@data-omni-key='AdditionalOffers']//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 1 (Tjänstekatalog)?']").hover();
            await this.page.locator("// vlocity_cmt-omniscript-step[@data-omni-key='AdditionalOffers']//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 1 (Tjänstekatalog)?']").click();
            await this.page.locator("//span[@part='label' and text()='Markera/Avmarkera alla']").first().click();
            //'Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?
            await this.page.locator("// vlocity_cmt-omniscript-step[@data-omni-key='AdditionalOffers']//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?']").hover();
            await this.page.locator("// vlocity_cmt-omniscript-step[@data-omni-key='AdditionalOffers']//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?']").click();
            await this.page.locator("//span[@part='label' and text()='Markera/Avmarkera alla']").nth(1).click();                       
            await this.nastaButton.click();
        }
        if (TestData.get("SalesFlowType") === "Renegotiation" ){
             ...
             //-- TC019
             //Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?
             //Would you like to add more offers to Appendix 2 (Customer Unique Prices)?

        await this.page.locator("//h2[text()='Steg']").hover();
        //await this.page.locator("//div[text()='Observera!']").hover();
        await this.page.locator("//div[text()='Välj avtalsmall']").hover();
        await this.page.locator("//div[text()='Vill du lägga till fler erbjudanden?']").hover();
        await this.page.locator("//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?']").hover();
        await this.page.locator("//lightning-formatted-text[text()='Vill du lägga till fler erbjudanden i bilaga 2 (Kundunika priser)?']").click();

        await this.page.locator("//span[text()='Markera/Avmarkera alla']//preceding-sibling::span").hover();
        await this.page.locator("//span[text()='Markera/Avmarkera alla']//preceding-sibling::span").click();       
        await this.nastaButton.click();
    ...
    async performMCSalesContractSendForSigning(TestData) {
        console.log("FuncMeth  :: performMCSalesContractSendForSigning,  TestData :: " + TestData ) 

        await this.page.waitForTimeout(10000);
        await this.page.locator('button').filter({ hasText: 'Skicka för e-signering' }).first().hover();
        ...
        if (AdditionalSignerIsNotNullOrEmpty) {
            ...
            await this.page.locator("//vlocity_cmt-omniscript-text-block[@data-omni-key='TextBlock2']//lightning-formatted-rich-text[contains(normalize-space(.),'Värdet på denna affär är över ditt mandat och kommer att skickas för signering')]").click();
            ...
            //Defect is raised for the english text B2XSET-307959
            await this.page.locator("//div[contains(@class,'show')]//button[contains(normalize-space(.) , 'Nästa')]").hover();            
            await this.page.locator("//div[contains(@class,'show')]//button[contains(normalize-space(.) , 'Nästa')]").click();
        }
        //ScriveDocumentViewPage
        await this.cartFrameScrive.locator("//table[@class='detailList']/tbody/tr[1]/td[text()='Draft']").click();
        await this.cartFrameScrive.locator("//table[@class='detailList']/tbody/tr[1]/td[contains(text(),'Avtal RA-')]").hover();
        await this.cartFrameScrive.locator("//table[@class='detailList']/tbody/tr[1]/td[contains(text(),'Avtal RA-')]").click();
        await this.cartFrameScrive.locator("//table[@class='detailList']//td[text()='Leveranssätt']//following-sibling::td[text()='Email']").hover();
        await this.cartFrameScrive.locator("//table[@class='detailList']//td[text()='Leveranssätt']//following-sibling::td[text()='Email']").click();
        await this.cartFrameScrive.getByText('Signing Party').first().hover();
        await this.cartFrameScrive.getByText('Signing Party').first().click();
        await this.cartFrameScrive.locator('span').filter({ hasText: /^Viewer$/ }).hover();
        await this.cartFrameScrive.locator('span').filter({ hasText: /^Viewer$/ }).click();
        await this.cartFrameScrive.getByRole('link', { name: 'Skicka' }).hover();
        await this.cartFrameScrive.getByRole('link', { name: 'Skicka' }).click();
        await this.cartFrameScrive.getByRole('cell', { name: 'Sent' }).hover();
        await this.cartFrameScrive.getByRole('cell', { name: 'Sent' }).click();
        await this.cartFrameScrive.getByRole('cell', { name: 'Avtal RA-' }).first().hover();
        await this.cartFrameScrive.getByRole('cell', { name: 'Avtal RA-' }).first().click();
        await this.cartFrameScrive.locator("//td[text()='Avtal']//following-sibling::td/a").first().hover();
        await this.cartFrameScrive.locator("//td[text()='Avtal']//following-sibling::td/a").first().click();
        await this.page.locator('lightning-formatted-text').filter({ hasText: 'Skickat för signering' }).hover();
    ...
    async performMCSalesContractManualSigning(utilityFunction) {
        //..**         console.log("FuncMeth  :: performMCSalesContractManualSigning,  utilityFunction :: " + utilityFunction ) 
        
        await this.page.waitForTimeout(10000);
        //await this.page.goto("https://telia--uatenv.sandbox.lightning.force.com/lightning/r/Contract/800JW00000OIRC2YAP/view");

        await this.page.waitForTimeout(10000);
        await this.page.locator("//button[text()='Manuellt signerat dokument mottaget']").click();
        await this.page.locator("//h2[text()='Manuellt signerat dokument mottaget']").click();
        const todaysDate = await utilityFunction.TodaysDate();
        console.log("todaysDate ::" + todaysDate);
         //Mottaget Datum        //2025-02-24
        //const todaysDateWithMottagetDatumformat = await utilityFunction.TodaysDateWithMottagetDatumformat();        
        //await this.page.locator("//input[@name='Received_Date']").type(todaysDateWithMottagetDatumformat);
        // await this.page.locator("//input[@name='CustomerSignedDate']").type(todaysDateWithMottagetDatumformat);
        //await this.manualSigningMottagetDatumCalendarIcon.click();
        
        await this.page.locator("//input[@name='Received_Date']").click();
        await this.page.waitForTimeout(2000);
        await this.page.locator("//table[@class='slds-datepicker__month']//tbody//td[@data-value='" + todaysDate + "']").hover();
        await this.page.locator("//table[@class='slds-datepicker__month']//tbody//td[@data-value='" + todaysDate + "']").click();
        await this.page.keyboard.press('Tab');
      

        //Kundsignaturdatum
        //await this.manualSigningKundsignaturDatumCalendarIcon.click(); 
        await this.page.locator("//input[@name='CustomerSignedDate']").click();
        await this.page.waitForTimeout(2000);         
        await this.page.locator("//table[@class='slds-datepicker__month']//tbody//td[@data-value='" + todaysDate + "']").hover();
        await this.page.locator("//table[@class='slds-datepicker__month']//tbody//td[@data-value='" + todaysDate + "']").click();
